...
import ht.edu.fds.mbds.android.bibliotheque.bean.LivreFacade;
...
public class LivreController implements Serializable {
    ...
    @EJB
    private ht.edu.fds.mbds.android.bibliotheque.bean.LivreFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    private AuteurLivre currentAuthor;
    ...
    public AuteurLivre getCurrentAuthor() {
        if(currentAuthor==null)
            currentAuthor = new AuteurLivre();
        return currentAuthor;
    }

    public void setCurrentAuthor(AuteurLivre currentAuthor) {
        this.currentAuthor = currentAuthor;
    }
    
    public void addAuthor(){
        if(getSelected().getAuteur()==null)
            getSelected().setAuteur(new ArrayList<AuteurLivre>());
        AuteurLivre clone = (AuteurLivre) currentAuthor.clone();
        clone.setLivre(current);
        getSelected().getAuteur().add(clone);
        currentAuthor = new AuteurLivre();
